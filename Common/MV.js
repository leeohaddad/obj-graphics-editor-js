...
function mult( u, v )
{
    ...
    if ( u.matrix && v.matrix ) {
        ...
        if ( u[0].length != v.length ) {
            throw "mult(): matrix lines and vector are not the same dimension";
        }
...
function vectorScale( s, u )
{
    if ( !Array.isArray(u) ) {
        throw "vectorScale: second parameter " + u + " is not a vector";
    }
